...
struct ControlOutput {
  ...
  TaskMode task_mode = TaskMode::Idle;
  bool task_feedback_valid = false;
  bool pid_active = false;
  bool chassis_valid = false;
  bool dmmc_stale = true;
  bool vision_soft_hold = false;
  bool vision_hard_lost = false;
  bool target_hold_deadband = false;
  bool projected_soft_boundary = false;
  int task3_stage = -1;
  ...
  double actual_u_m_s2 = 0.0;
  double requested_u_m_s2 = 0.0;
  double desired_theta_rad = 0.0;
  bool theta_rate_limited = false;
  bool theta_angle_limited = false;
  double vision_age_ms = std::numeric_limits<double>::infinity();
  double vision_input_age_ms = std::numeric_limits<double>::infinity();
  ...
  VisionMeasurement latest_vision;
  double vision_raw_position_m = 0.0;
  std::int64_t vision_frame_delta = 0;
  bool vision_measurement_accepted = false;
  std::string vision_update_reason = "no_vision_packet";
  std::string vision_health_reason = "no_vision_packet";
  std::uint64_t vision_received_frames = 0;
  std::uint64_t vision_accepted_frames = 0;
  std::uint64_t vision_status_lost_frames = 0;
  std::uint64_t vision_duplicate_frames = 0;
  std::uint64_t vision_missing_frames = 0;
  std::uint64_t observer_rejected_measurements = 0;
  std::uint64_t observer_too_old_measurements = 0;
  double observer_cov_xx = 0.0;
  double observer_cov_xv = 0.0;
  double observer_cov_xd = 0.0;
  double observer_cov_vv = 0.0;
  double observer_cov_vd = 0.0;
  double observer_cov_dd = 0.0;
  std::string dmmc_health_reason = "no_dmmc_status";
  std::uint64_t dmmc_status_frames = 0;
  std::uint64_t dmmc_duplicate_frames = 0;
  std::uint64_t dmmc_missing_frames = 0;
  std::uint64_t chassis_status_frames = 0;
  std::uint64_t chassis_duplicate_frames = 0;
  std::uint64_t chassis_missing_frames = 0;
  PidResult pid;
